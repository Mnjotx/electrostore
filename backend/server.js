...
app.get("/api/laptop", async (req, res) => {
    const result = await pro.find({ Category: '69fc207795f242419555e641' }).limit(8)
    if (result) {
        res.send({ statuscode: 1, data: result })
    }
    else {
...
app.get("/api/mobiles", async (req, res) => {
    const result = await pro.find({ Category: "69f97d54c7b314e3bd5cfd1c" }).limit(8)
    if (result) {
        res.send({ statuscode: 1, data: result })
    }
    else {
...
app.get("/api/leds", async (req, res) => {
    const result = await pro.find({ Category: "69fc216095f242419555e674" })
    if (result) {
        res.send({ statuscode: 1, data: result })
    }
    else {
...
app.get("/api/airpods", async (req, res) => {
    const result = await pro.find({ Category: "6a01696dd50408a5bdc4e6c1" })
    if (result) {
        res.send({ statuscode: 1, data: result })
    }
    else {
